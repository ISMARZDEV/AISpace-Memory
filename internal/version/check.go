// Package version checks for newer aispace-men releases on GitHub.
package version
...
func updateInstructions() string {
	switch runtime.GOOS {
	case "darwin":
		return "  brew install aispace/tap/aispace-men"
	case "linux":
		return "  brew install aispace/tap/aispace-men\n  or: go install github.com/aispace/men/cmd/aispace-men@latest"
	default:
		return "  go install github.com/aispace/men/cmd/aispace-men@latest\n  or: https://github.com/aispace/men/releases/latest"
	}
}
