// Package store implements the persistent memory engine for aispace-men.
//
...
func DefaultConfig() (Config, error) {
	...
	return Config{
		DataDir:              filepath.Join(home, ".aispace-men"),
...
func New(cfg Config) (*Store, error) {
	...
	dbPath := filepath.Join(cfg.DataDir, "aispace-men.db")
